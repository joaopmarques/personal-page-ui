...
const Header = ({ ...props }) => {
  ...
  return (
    <header
      className={`transition-all px-20 fixed z-50 top-0 left-0 w-full bg-white ${ shortened ? "py-4" : "py-10" } ${ overscrolled && "backdrop-filter backdrop-blur-lg bg-opacity-60" }`}
    >
